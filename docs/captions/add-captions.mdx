    ...
    <Tabs>
        <Tab title="iOS">
            **Automatically add captions to your video**
            ...
            1. [Import](/docs/start/create-a-project/import) or [record your video](/docs/start/create-a-project/camera)
        ...
        <Tab title="Desktop">
            **Automatically add captions to your video:**
            ...
            1. [Import](/docs/start/create-a-project/import) your video
            2. Select the language that is being spoken
            3. Keep “No Translation” or select a language to translate captions
