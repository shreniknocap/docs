...
### [Sign in with Microsoft](/docs/app/ios) ###
...
### [Video Overlay (Picture in Picture)](/docs/visual/media) ###
...
### [New Transitions](/docs/timeline/transitions) ###
...
### [Manual Text](/docs/visual/text) ###

Add text (other than captions) to your video. Learn more.

### [Insert Clip & Merge Clips](/docs/timeline/add-clips) ##
...
### [Improved multi-select imports](/docs/project/import) ###

When importing multiple clips, tap the multi-select icon to save some time.

### [Media in Timeline](/docs/visual/media) ###
...
### [Search bar added to language selector](/docs/translation/dubbing) ###

With our growing list of supported languages, now you can search for your language.

### [15 new languages supported](/docs/translation/dubbing) ###
...
### [AI Dubbing](/docs/translation/dubbing) ###

Now, you can dub your video into 28 languages!

### [AI Voiceover](/docs/audio/voiceover) ###
...
### [Sound Effects](/docs/audio/sounds) ###
...
### [Film in landscape mode](/docs/project/camera) ###
...
### [Export in 4:5 scale](/docs/settings/export) ###
...
### [New Language - Slovenian](/docs/translation/dubbing) ###
Add captions in Slovenian.

### [AI Generated Hashtags](/docs/settings/managing-projects) ###
Simply tap a button to get hashtags to paste into your social post.

### [Script Generator](/docs/project/script) ###
Need help coming up with an idea? Let us help!

### [Updated export screen](/docs/settings/export) ###
