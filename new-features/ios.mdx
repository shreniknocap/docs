...
### [Sign in with Microsoft](/docs/start-guide/get-the-app/ios) ###
...
### [Video Overlay (Picture in Picture)](/docs/visual-editing/media) ###
...
### [New Transitions](/docs/timeline-editing/transitions) ###

Weve added 8 new and fun transitions! Learn more about transitions.

### [Word/Phrase View](/docs/captions/adjust-timing) ###
...
### [Current time on the timeline](/docs/captions/adjust-timing) ###

A long time coming, now view your current time in your video with a timestamp.

## November ##

### [Manual Text](/docs/visual-editing/text) ###

Add text (other than captions) to your video. Learn more.

### [Insert Clip & Merge Clips](/docs/timeline-editing/add-clips) ##
...
### [AI Emphasis/Emojis moved to the Style section](/docs/captions/styles) ###
...
### [Improved multi-select imports](/docs/start-guide/create-a-project/import) ###

When importing multiple clips, tap the multi-select icon to save some time.

### [Media in Timeline](/docs/visual-editing/media) ###
...
### [AI Dubbing](/docs/translation-and-dubbing/dubbing) ###

Now, you can dub your video into 28 languages!

### [AI Voiceover](/docs/audio-editing/voiceover) ###

Add an AI Voiceover using one of 9 

### [Animated Emojis](/docs/captions/word-effects) ###

Choose from over 50 animated emojis in addition to standard emojis.

### [App available in 9 languages](/docs/project-settings/app-language) ###

To make the app accessible to our customers around the globe, we Localized the app in 9 languages

## May ##

### [AI Music](/docs/audio-editing/music) ###

Add a royalty-free, AI-generated track to your project.

### [AI Denoise](/docs/audio-editing/enhance) ###

Cut through the noise by muting background noise and echoes

### [Transitions](/docs/timeline-editing/transitions) ###

Add transitions to your project

## April ##

### [AI Title](/docs/visual-editing/title) ###

Add an AI-generated intro to your project

### [Project Drafts](/docs/project-settings/managing-projects) ###

Your work is now automatically saved as a draft

### [Improvements to auto-generate hashtags](/docs/project-settings/managing-projects) ###

Easily generate and copy hashtags to paste into your post

## March ##

### [Improvements to Teleprompter](/docs/start-guide/create-a-project/teleprompter) ###

Teleprompter got a makeover.

### [AI Images](/docs/visual-editing/media) ###

Automatically add relevant images to your project based on the captions

### [Add GIFs](/docs/visual-editing/media) ###

Add GIFs to your project

## February ##

### [New Language - Hinglish/Himdi](/docs/translation-and-dubbing/dubbing) ###

We now support Himdi!

## January ##

### [Supersize](/docs/captions/word-effects) ###

Supersize individual words

### [Sound Effects](/docs/audio-editing/sounds) ###

Add sound effects to your project

### [Rotate captions, emojis, and images](/docs/captions/move-and-resize) ###

Use two fingers to rotate captions, emojis, and images

### [Film in landscape mode](/docs/start-guide/create-a-project/camera) ###

Go 90 to film horizontally.

### [Snap captions to center](/docs/captions/move-and-resize) ###
...
### [Randomize captions style](/docs/captions/styles) ###

Why pick just one style, use randomize to cycle between styles

### [Export in 4:5 scale](/docs/project-settings/export) ###
...
### [New fonts added](/docs/captions/styles) ###
Brand new fonts!

### [New Language - Slovenian](/docs/translation-and-dubbing/dubbing) ###
Add captions in Slovenian.

### [AI Generated Hashtags](/docs/project-settings/managing-projects) ###
Simply tap a button to get hashtags to paste into your social post.

### [Script Generator](/docs/start-guide/create-a-project/script) ###
Need help coming up with an idea? Let us help!

### [Updated export screen](/docs/project-settings/export) ###
