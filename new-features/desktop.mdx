...
### [Profile & Support](/docs/start-guide/subscriptions) ###
...
### [Redesign](/docs/start-guide/get-the-app/desktop) ###
...
### [Sound wave below timeline](/docs/start-guide/get-the-app/desktop) ###
...
### [Split & Delete Clip](/docs/timeline-editing/split-delete) ###
Easily split your clip and delete clips.

### [AI Dubbing added](/docs/translation-and-dubbing/dubbing) ###
Dub your video into nearly 30 languages.

### [Advanced export options](/docs/project-settings/export) ###
Now, you can adjust your quality and bitrate before exporting.

## October ##

### [Thumbnails added to bottom nav](/docs/start-guide/get-the-app/desktop) ###
...
### [Desktop app released in beta](/docs/start-guide/get-the-app/desktop) ###
